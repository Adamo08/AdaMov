                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-6 d-flex align-items-center justify-content-center">
                                <img src="<?php echo ADMINASSETS ?>img/forgot_password.svg" alt="Forgot Password"
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Don't worry! Enter your email address below, and we’ll send you a link to reset your password.</p>
                                    </div>
                                    <form class="user">
                                        ...
                                        <a href="reset_password.html" class="btn btn-primary btn-user btn-block">
                                            Send Reset Link
                                        </a>
                                    </form>
                                    <hr>
