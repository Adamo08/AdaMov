                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-6 d-flex align-items-center justify-content-center">
                                <img src="<?php echo ADMINASSETS ?>img/login_image.svg" alt="Login Image"
                                    class="img-fluid">
                            </div>
                            <!-- Login Form Column -->
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Back <span class="px-2 btn-primary rounded">Admin!</span></h1>
                                    </div>
                                    <?php if (isset($failed)): ?>
                                    ...
                                    <?php endif?>
                                    <form class="user" action="<?=url("admin/signin")?>" method="POST">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo url("admin/forgot_password")?>">Forgot Password?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
